            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="registerProceed.php" method="POST" class="register-form" id="register-form" onsubmit="return validateForm()">
                    ...
                    <div class="signup-image">
                        <figure>
                            <img src="images/login-signup-image.png" alt="sign up image">
                        </figure>
